...
void ui_actor_state_wnd::init_from_xml( CUIXml& xml, LPCSTR path )
{
	...
	if (xml.NavigateToNode("main_state"))
...
// show radiation icon
    ...
    {
        const float max_power = actor->conditions().GetMaxWoundProtection();
