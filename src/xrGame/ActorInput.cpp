...
void CActor::IR_OnKeyboardPress(int cmd)
{
	...
	case kCAM_4:
	{
		...
		//morrazzzz: In no case do not add case 0!	
		switch (m_cam_active)
		{
		case 1:
			cam_Set(eacFreeLook);
...
{
	if(hud_adj_mode && pInput->iGetAsyncKeyState(DIK_LSHIFT) && g_player_hud)	return;
...
#pragma todo("morrazzzz: The problem with kDROP is here, understand the reason and fix it.")
		case kDROP:		
