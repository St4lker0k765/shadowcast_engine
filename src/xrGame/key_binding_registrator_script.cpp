		...
		[
				...
				[
					value("VK_PAD_A", int(VK_PAD_A)),
						...
						value("VK_PAD_DPAD_UP", int(VK_PAD_DPAD_UP)),
						value("VK_PAD_DPAD_DOWN", int(VK_PAD_DPAD_DOWN)),
						value("VK_PAD_DPAD_LEFT", int(VK_PAD_DPAD_LEFT)),
						value("VK_PAD_DPAD_RIGHT", int(VK_PAD_DPAD_RIGHT)),
