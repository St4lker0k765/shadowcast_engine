...
void gamepad_key_binding_registrator::script_register(lua_State* L)
{
	module(L)
		[
				class_<gamepad_key_binding_registrator >("VK_keys")
				.enum_("vk_keys")
				[
					value("VK_PAD_A", int(VK_PAD_A)),
						value("VK_PAD_B", int(VK_PAD_B)),
						value("VK_PAD_X", int(VK_PAD_X)),
						value("VK_PAD_Y", int(VK_PAD_Y)),
						value("VK_PAD_RSHOULDER", int(VK_PAD_RSHOULDER)),
						value("VK_PAD_LSHOULDER", int(VK_PAD_LSHOULDER)),
						value("VK_PAD_LTRIGGER", int(VK_PAD_LTRIGGER)),
						value("VK_PAD_RTRIGGER", int(VK_PAD_RTRIGGER)),
						value("XINPUT_GAMEPAD_DPAD_UP", int(XINPUT_GAMEPAD_DPAD_UP)),
						value("XINPUT_GAMEPAD_DPAD_DOWN", int(XINPUT_GAMEPAD_DPAD_DOWN)),
						value("XINPUT_GAMEPAD_DPAD_LEFT", int(XINPUT_GAMEPAD_DPAD_LEFT)),
						value("XINPUT_GAMEPAD_DPAD_RIGHT", int(XINPUT_GAMEPAD_DPAD_RIGHT)),
						value("VK_PAD_START", int(VK_PAD_START)),
						value("VK_PAD_BACK", int(VK_PAD_BACK)),
						value("VK_PAD_LTHUMB_PRESS", int(VK_PAD_LTHUMB_PRESS)),
						value("VK_PAD_RTHUMB_PRESS", int(VK_PAD_RTHUMB_PRESS)),
						value("VK_PAD_LTHUMB_UP", int(VK_PAD_LTHUMB_UP)),
						value("VK_PAD_LTHUMB_DOWN", int(VK_PAD_LTHUMB_DOWN)),
						value("VK_PAD_LTHUMB_RIGHT", int(VK_PAD_LTHUMB_RIGHT)),
						value("VK_PAD_LTHUMB_LEFT", int(VK_PAD_LTHUMB_LEFT)),
						value("VK_PAD_LTHUMB_UPLEFT", int(VK_PAD_LTHUMB_UPLEFT)),
						value("VK_PAD_LTHUMB_UPRIGHT", int(VK_PAD_LTHUMB_UPRIGHT)),
						value("VK_PAD_LTHUMB_DOWNRIGHT", int(VK_PAD_LTHUMB_DOWNRIGHT)),
						value("VK_PAD_LTHUMB_DOWNLEFT", int(VK_PAD_LTHUMB_DOWNLEFT)),
						value("VK_PAD_RTHUMB_UP", int(VK_PAD_RTHUMB_UP)),
						value("VK_PAD_RTHUMB_DOWN", int(VK_PAD_RTHUMB_DOWN)),
						value("VK_PAD_RTHUMB_RIGHT", int(VK_PAD_RTHUMB_RIGHT)),
						value("VK_PAD_RTHUMB_LEFT", int(VK_PAD_RTHUMB_LEFT)),
						value("VK_PAD_RTHUMB_UPLEFT", int(VK_PAD_RTHUMB_UPLEFT)),
						value("VK_PAD_RTHUMB_UPRIGHT", int(VK_PAD_RTHUMB_UPRIGHT)),
						value("VK_PAD_RTHUMB_DOWNRIGHT", int(VK_PAD_RTHUMB_DOWNRIGHT)),
						value("VK_PAD_RTHUMB_DOWNLEFT", int(VK_PAD_RTHUMB_DOWNLEFT))
				]
		];
}