...
void CDamageManager::reload				(LPCSTR section,const CInifile* ini)
{
...
void CDamageManager::reload(LPCSTR section,LPCSTR line,const CInifile* ini)
{
...
void CDamageManager::init_bones(LPCSTR section,const CInifile* ini)
{
...
void CDamageManager::load_section(LPCSTR section,const CInifile* ini)
{
	string32				buffer;
	IKinematics				*kinematics = smart_cast<IKinematics*>(m_object->Visual());
